...
\item[Miscellaneous:]
HTML; CSS; IPv4 and IPv6 networking; excellent troubleshooting, problem solving, and debugging skills; very quick learner.
\end{description}
...
\affiliation[Level 2 Technical Support]{Versata}{2011-2012}
\begin{compactitem}
\item Creating custom solutions tailored to customer environments.
\item Assisting in Quality Assurance for new releases before going out to customers
\item Fixing bugs in supported products
\item Assisting the training of new personnel
\end{compactitem}

\affiliation[System Administrator]{Jeff Stewart}{2011}
\begin{compactitem}
\item Determine the cause of service interruptions from software crashes
\item Diagnose network interruptions and worked with service provider to fix and provide a time-line to customers
\item Provide direct technical support to customers to fix or work around any issues that come up
\end{compactitem}
...
\section{References}
\begin{tabular}{lll}
\rowcolor{white} Jeff Stewart & Client & dirkson@frogstar.com \\
