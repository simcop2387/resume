...
\item Banking and Auto Customer Service Bots
	...
	\item Completed Ally Auto customer service bot agent
	\item Significantly expanded Banking side of customer service agent
		\begin{compactitem}
		\item Expanded time-relevant tax-based customer help by adding automatic and dynamic content to address common customer issues
		\item Deeply integrated multiple banking systems into the agent, enabling customers to replace debit cards, check wire transfer status, and resolve other common issues
		\end{compactitem}
	\end{compactitem}
	...
	\item Led organizational migration from one AWS account to another line of business (Tech to Customer Service) with minimal downtime
	\item Aided in decommissioning the Rasa agent project by planning migration to a new vendor platform
\end{compactitem}
