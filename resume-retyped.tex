...
\streetaddress{3000 Chestnut Grove Ln. APT 3308}
\citystatezip{Matthews, NC 28104}
% \citystatezip{  }
...
Perl, Python, JavaScript (Node, react and others), C/C++, SQL
...
\affiliation{Team Lead}{Ally Financial Inc.}{May 2021-Jan 2026}
\begin{compactitem}
\item Banking and Auto Customer Service Bots
	\begin{compactitem}
	\item Redesigned customer authentication mechanism to increase security and remove race conditions
	\item Migration from Amazon Lex to more capable and flexible Rasa based conversation agent
	\item Completed creation of Auto line of business customer service bot agent
	\item Significantly expanded Banking side of customer service agent
		\begin{compactitem}
		\item Expanded time-relevant tax based customer help by add automatic and dynamic content to handle common customer issues
		\item Deeply integrated multiple parts of the banking line of business into the agent allowing customers to quickly replace debit cards, get wire status, and a number of other customer facing products and common issues
		\end{compactitem}
	\end{compactitem}
	\item Aided product management in design of customer facing flows
	\item helped analyze and debug NLU classification of customer inputs to correct issues in training data and agent flow designs (n.b. debit card and credit card nlu confusions etc.)
	\item Documented NLU model risk and compliance with internal regulations
	\item Maintained PII scanning and masking service
	\item Handled large internal migration from internal organizations from one aws account to another line of business (tech to customer service internal orgs) with minimal downtime
	\item Helped the decomissioning of the Rasa agent project by helping plan the recreation of the agents on a new vendor platform to replace the existing system
\end{compactitem}
