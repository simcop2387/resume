...
\rowcolor{lightgray} Diane Xu & Engineering Manager & dxu@rent.com \\
\rowcolor{white} Mike Rozek & Manager & mike@rozeks.com
\end{tabular}
\end{document}
