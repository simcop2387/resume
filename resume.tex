...
\section{Objective}
To start a career developing software that will challenge my knowledge and require me to expand my abilities...
...
\begin{compactitem}
\item MediaSched is a program for easily running any kind of scheduled and unscheduled media playback.  Supporting the use of existing calendar/scheduling software for the selection of simple to complex playlists.
